...
String subType=com.whir.component.security.crypto.EncryptUtil.htmlcode(request,"subType");
...
String processType=request.getParameter("processType")==null?"":com.whir.component.security.crypto.EncryptUtil.htmlcode(request,"processType");
String  comboxType="ext";
if(whir_agent.indexOf("Firefox/4")>0){
	comboxType="";
}

String showSmsRemind=request.getAttribute("showSmsRemind")==null?"":request.getAttribute("showSmsRemind").toString(); 
String showMailRemind=request.getAttribute("showMailRemind")==null?"":request.getAttribute("showMailRemind").toString(); 
String showRtxRemind=request.getAttribute("showRtxRemind")==null?"":request.getAttribute("showRtxRemind").toString();
					...
					<td colspan="2">
						<div class="Public_tag">
							<ul>
								...
								<!-- <li id="Panle2" onClick="changePanle(2);"><span class="tag_center">外部数据源配置</span><span class="tag_right"></span>
								</li> -->
							</ul>
						</div>
					</td>
					...
					<td valign="top">
						<div id="docinfo0" style="display:;">
				            <table width="100%" border="0" class="Table_bottomline" cellpadding="0" cellspacing="0">
								...
								<!-- 子表数据控制 -->
								<!--<input name="subTableDataControlModi"  id="subTableDataControlModi" type="checkbox" value="true">允许修改已有行数据&nbsp;&nbsp;&nbsp;&nbsp;-->
								<tr>
									<td  class="td_lefttitle" ><s:text name="workflow.subTableDataControl"/>：</td>
									<td>
										<div style="padding-top:4px;padding-bottom:3px;">
											<input name="subTableDataControlAdd"  id="subTableDataControlAdd" type="checkbox" value="true"><s:text name="workflow.addNewRow"/>&nbsp;&nbsp;&nbsp;&nbsp;<input name="subTableDataControlAddNull"  id="subTableDataControlAddNull" type="checkbox" value="true"><s:text name="workflow.addNewNullRow"/>&nbsp;&nbsp;&nbsp;&nbsp;<input name="subTableDataControlDel"  id="subTableDataControlDel" type="checkbox" value="true"><s:text name="workflow.delDataRow"/>
										</div>
									</td>
									<td>&nbsp;</td>
								</tr>
								...
								<%//&&!moduleId.equals("91")&&!moduleId.equals("92")&&!moduleId.equals("93")&&!moduleId.equals("50")%>
								...
								<%//92 项目管理     50  文档管理 &&!moduleId.equals("91")&&!moduleId.equals("92")&&!moduleId.equals("93")&&!moduleId.equals("50")  %>
								<tr  id="tr_showremind" <%if(!moduleId.equals("1")){out.print("style=\"display:none\"");}%>  >
									...
									<td>
										...
										<div><span class="MustFillColor" style="padding-left: 0px;">请不要输入{}$,' 等特殊字符，以免破坏格式<br>
								...
								<!--流程办结提醒-->
								<%if(showRtxRemind.equals("true") || showSmsRemind.equals("true") || showMailRemind.equals("true")){%>
								<tr>
									<td class="td_lefttitle" >流程办结提醒：</td>
									<td>
										<!--<input name="processEndMail" type="checkbox" value="true"><s:text name="workflow.set_completeprocesswithemail"/>-->
										<%if(showRtxRemind.equals("true")){%><input name="processEndRtx" type="checkbox" value="true">即时通讯<%}%>
										<%if(showSmsRemind.equals("true")){%><input name="processEndSms" type="checkbox" value="true">短信<%}%>
										<%if(showMailRemind.equals("true")){%><input name="processEndMail" type="checkbox" value="true">邮件<%}%>
									</td>
								</tr>
								<%}%>
								<!--设置项-->
								...
								<tr>
									...
									<td> 
										<div style="padding-top:4px;padding-bottom:3px;">
											...
											<INPUT value="1" type="radio" name="processNeedDossierType">档案类目&nbsp;<select name="processNeedDossierPath" style="width:100px;"><option value="">--请选择--</option>
											<%
											...
											<br><input name="processNoBackSubmitUser" type="checkbox" value="true">不允许退回给流程启动人&nbsp;&nbsp;&nbsp;&nbsp;<input name="processKeepBackComment" type="checkbox" value="true"><s:text name="workflow.set_backsavecomment"/>&nbsp; &nbsp;&nbsp;&nbsp;<input name="processKeepReSubmitComment" type="checkbox" value="true"><s:text name="workflow.keepComments"/><br>
											...
											<input name="processAutoNextWithNullUser"  id="processAutoNextWithNullUser" type="checkbox" value="true">是否同步交换平台
										</div> 
									</td>
									<td>&nbsp;</td>
								</tr> 
								...
								<tr <%if(moduleId.equals("50") || moduleId.equals("52")||!com.whir.ezflow.util.EzFlowFinals.ENABLE_COMPLETE_BACK||true){%>style="display:none;"<%}%>>
									<td  class="td_lefttitle" for='不可以激活到的节点'>不可以激活到的节点：</td>
									<td>
										 <div id="nojihuoallActIdsDiV">
										 </div> 
									</td>
									<td>&nbsp;</td>
								</tr>

								<tr <%if(moduleId.equals("50") || moduleId.equals("52")||!com.whir.ezflow.util.EzFlowFinals.ENABLE_BAOHAN_NOWATING){%>style="display:none;"<%}%>>
									<td  class="td_lefttitle" for='不等待包含网管'>不等待包含网管：</td>
									<td>
										 <div id="nowaitingBaohanGatyDiV">
										 </div> 
									</td>
									<td>&nbsp;</td>
								</tr>
