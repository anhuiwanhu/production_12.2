		...
		<tr class="Table_nobttomline" id="tipsmstr" style="display:none">
			<td colspan="2"> 
				<div id="smsContentTR" style="padding: 7px;display:none">
					<textarea name="temp_smsContent"  id="temp_smsContent" wrap="physical"   class="inputTextarea" style="width:100%;height:60px"><%=request.getAttribute("smsContent")==null?"": com.whir.component.security.crypto.EncryptUtil.escapeHtml3(request.getAttribute("smsContent").toString())%></textarea>
				</div>
			</td>
		</tr>
