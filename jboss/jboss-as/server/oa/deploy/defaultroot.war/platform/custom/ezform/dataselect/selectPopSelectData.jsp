...
<%
String selectType = EncryptUtil.htmlcode(request.getParameter("selectType"));
String fieldId = request.getParameter("fieldId")!=null?EncryptUtil.htmlcode(request.getParameter("fieldId")):"";
String fieldValue = request.getParameter("fieldValue")!=null?EncryptUtil.htmlcode(request.getParameter("fieldValue")):"";
String fieldName = request.getParameter("fieldName")!=null?EncryptUtil.htmlcode(request.getParameter("fieldName")):"";
String popIndex = request.getParameter("popIndex")!=null?EncryptUtil.htmlcode(request.getParameter("popIndex")):"0";
...
function save(tag){
	if(tag=='close'){
		...
		if (checks) {
			...
			pVal1 = pVal1.replace(/<br\/>/g,"\n");
			val3 = val3.replace(/<br\/>/g,"\n");
