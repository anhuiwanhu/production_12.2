...
<table width="100%" border="0" cellpadding="2" cellspacing="0" class="Table_bottomline">
    ...
    <tr>
        ...
        <td><s:textfield name="userPO.empEnglishName" id="empEnglishName" cssClass="inputText" cssStyle="width:92%;" whir-options="vtype:['spechar3']" maxlength="25"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input onclick="checkMobile(this)" type="checkbox" name="userPO.mobileUserFlag" <s:if test="userPO.mobileUserFlag == 1">checked</s:if> id="mobileUserFlag" value="1">evo客户端</input>
            ...
            <input  onclick="checkEnterprisenumber(this)" type="checkbox" name="userPO.enterprisenumber" <s:if test="userPO.enterprisenumber == 1">checked</s:if> id="enterprisenumber" value="1">evo+</input>
        </td>
