					...
					<li>
                       <div class="wh-slide-sim-consult-box">
                       		<div class="wh-slide-sim-look">
                                   ...
                                   <img src="<%=fileArray[a]%>" onclick="openWin({url:'<%=linkArray[a]%>',winName:'info',isFull:true});" alt="<%=textArray[a]%>" style="cursor:pointer"/>
                               </div>
                           </div>
                       </div>
                   </li>
