...
//20170718 -by jqq 登录状态判断，跳转到不同的信息查看页
        ...
        <%
            if("1".equals(topPreview)){
                ...
                if("true".equals(ivo.getIsConf())){
                    ...
                    if(_outter_ && (userId==null || userId.equals("null") || userId.equals("-1")) )_link="openWin({url:'"+rootPath+"/PortalInformation!getInformation.action?title="+ivo.getPoptitle()+"&id="+ivo.getId()+"', isFull:true});";
                }else{
