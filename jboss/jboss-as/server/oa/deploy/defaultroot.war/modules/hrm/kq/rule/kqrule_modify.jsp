    ...
    <div class="wh-view wh-detail wh-d-contact">
      ...
      <div class="container">
        ...
        <div class="details-container details-container-e">
              <div class="row">
                <s:form class="form-horizontal clearfix" role="form" name="dataForm" id="dataForm"     action="kqrule!kqrule_update.action" method="post" theme="simple">
				 <input name="kqrule.ruleId" value="${ruleId}" type="hidden" id="ruleId" />
                  <div class="form-group col-wh-12" style="margin-top:20px;">
                    ...
                    <div class="form-group col-wh-10">
                       <input type="text" class="form-control" name="kqrule.ruleName" id="ruleName" maxlength="20" value="${kqrule.ruleName}">
                    </div>
                  </div>
                    ...
                    <div class="form-group col-wh-10 type-tab-title">
					 <c:choose>
					   ...
					   <c:when test="${kqrule.ruleType == '2'}">
					      <label class="radio-inline">
							 <input type="radio" name="kqrule.ruleType" value="1" > 地理位置
						  </label>
						  <label class="radio-inline">
							<input type="radio" name="kqrule.ruleType" value="2" checked> WIFI范围
						  </label>
						 <!-- <label class="radio-inline">
							<input type="radio" name="kqrule.ruleType" value="3"> 蓝牙范围（ibeacon）
						  </label>-->
					   ...
					   <c:when test="${kqrule.ruleType == '3'}">
						 ...
						 <!-- <label class="radio-inline">
							<input type="radio" name="kqrule.ruleType" value="3" checked> 蓝牙范围（ibeacon）
						  </label>-->
					   </c:when>
				    </c:choose>		
                    ...
                    <div class="form-group col-wh-10">
					 <c:choose>
						<c:when test="${kqrule.ruleException == '1'}">
						  <label class="radio-inline">
							<input type="radio" name="kqrule.ruleException" value="1" checked>允许
						  </label>
						  <label class="radio-inline">
							<input type="radio" name="kqrule.ruleException" value="2" > 不允许
						  </label>
					   </c:when>
                  ...
                  <div class="form-group col-wh-12">
					...
					<c:when test="${kqrule.ruleAlert == '1'}">
						  <label class="radio-inline">
							<input type="radio" name="kqrule.ruleAlert" value="1" onclick="show();" checked >是
						  </label>
						  <label class="radio-inline">
							<input type="radio" name="kqrule.ruleAlert" value="2"  onclick="hide();"> 否
						  </label>
					   </c:when>
                      ...
                      <span id = "isShow">
                      <label class="radio-inline control-label-a" >提前 <em style="vertical-align: middle;padding-left: 8px;">*</em>  <input type="text" class="form-control" value="${kqrule.ruleAlertTime}" id="ruleAlertTime" name="kqrule.ruleAlertTime" onkeyup="value=this.value.replace(/\D/g,'')"  maxlength="5">分钟提醒</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					  <%
                  ...
                  <!-- <div class="form-group col-wh-12">
                       <label class="control-label col-wh-2" for=" ">提醒打卡：</label>
                       <div class="control-label col-wh-10">
                    <label class="radio-inline">
                      <input type="radio" name=" " id=" ">是
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name=" " id=" "> 否
                    </label>
                    <label class="control-label control-label-a">提前  <input type="text" class="form-control"  name=" " id=" ">分钟提醒</label>
                       </div>
                  </div> -->
                   <div class="form-group col-wh-12">
                   <label class="control-label col-wh-2" for=" ">适用范围<em style="vertical-align: middle;padding-left: 8px;">*</em>：</label>
					...
					<input type="hidden" class="form-control form-control-wh-line" name = "kqrule.ruleRangeIds" id="ruleRangeIds" value="${kqrule.ruleRangeIds}">
                      <!-- <input type="text" class="form-control" name = "kqrule.ruleRange" id="ruleRange" value="${kqrule.ruleRange}" readonly="readonly" style="background-color:white;">
                       <div class="input-group-btn"><a href="javascript:void(0)" class="btn btn-wh-line" onclick="openSelect_layer({allowId:'ruleRangeIds', allowName:'ruleRange', select:'orgusergroup', single:'no', show:'orgusergroup', range:'*0*'});"><i>...</i></a></div>-->
					     ...
					     <textarea name = "kqrule.ruleRange" id="ruleRange"   rows="3"  readonly="true"  class="form-control"  style="background-color:white;min-height:0;height:100px;" readonly="readonly">${kqrule.ruleRange}</textarea>
                   ...
                   <div class="type-tab-contact">
                      <div class="tab dlwz" style="display:block">
						 ...
						 <div class="form-group col-wh-12">
                              ...
                              <input type="text" class="form-control" name="kqrule.ruleAddress" id="ruleAddress" value="${kqrule.ruleAddress}"  maxlength="24">
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                               <label style="font-weight:400;">范围<em style="vertical-align: middle;padding-left: 8px;">*</em>：</label>
                              <input type="text" class="form-control" name="kqrule.ruleScope" id="ruleScope" value="${kqrule.ruleScope}" onkeyup="value=this.value.replace(/\D/g,'')"  maxlength="5">
						 ...
						 <div class="form-group col-wh-12" >
                              ...
                              <input type="text" class="form-control" name="kqrule.ruleLongitude" id="ruleLongitude" value="${kqrule.ruleLongitude}" onkeyup="value=value.replace(/[^\d.]/g,'')" maxlength="18">
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                               <label style="font-weight:400;">维度<em style="vertical-align: middle;padding-left: 8px;" >*</em>：</label>
                              <input type="text" class="form-control" name="kqrule.ruleLatitude" id="ruleLatitude" value="${kqrule.ruleLatitude}" onkeyup="value=value.replace(/[^\d.]/g,'')" maxlength="18">
                         </div>
                      ...
                      <div class="tab wifi">
						 ...
						 <div class="form-group col-wh-12">
                              ...
                              <input type="text" class="form-control" name="kqrule.ruleWifiIpStr" id="ruleWifiIpStr"  value="${kqrule.ruleWifiIpStr}" style="width:88%!important"  maxlength="1000" onkeyup="value=value.replace(/[^\d.,]/g,'')">
                         </div>
						 </div>
                       ...
                       <div class="tab ibeacon">
                          <div class="tab-ser clearfix">
                            <div class="form-group col-wh-12">
                              ...
                              <input type="text" class="form-control" name="kqrule.ruleUuid" id="ruleUuid"  value="${kqrule.ruleUuid}" maxlength="200">
                            </div>
                             <div class="form-group col-wh-12">
                                 <label class="col-wh-3 control-label">Major（主值）<em style="vertical-align: middle;padding-left: 8px;">*</em>：</label>
                                <input type="text" class="form-control" name="kqrule.ruleMajor" id="ruleMajor" value="${kqrule.ruleMajor}" maxlength="50">
                              </div>
                               <div class="form-group col-wh-12">
                                 <label class="col-wh-3 control-label">Minor（主值）<em style="vertical-align: middle;padding-left: 8px;">*</em>：</label>
                                 <input type="text" class="form-control" name="kqrule.ruleMinor" id="ruleMinor" value="${kqrule.ruleMinor}" maxlength="50">
                               </div>
                                <div class="form-group col-wh-12">
                                    <label class="col-wh-3 control-label">识别距离<em style="vertical-align: middle;padding-left: 8px;">*</em>：</label>
                                    <input type="text" class="form-control" name="kqrule.ruleDistance" id="ruleDistance" value="${kqrule.ruleDistance}" onkeyup="value=this.value.replace(/\D/g,'')" maxlength="5">
                                  </div>
                         </div>
                      </div>
                  </div>
...
//百度地图API功能
	...
	function init() {       	
		...
		ac.setInputValue("${kqrule.ruleAddress}");
  ...
  $(function() {
	...
	function saveExit(){
		...
		if(rulename==''){
		   ...
		   return false;
		       ...
		       var oldruleid = $("#ruleId").val();
		       $.post('<%=rootPath%>/kqrule!isRepeat.action',{'ruleId':oldruleid,'ruleName':rulename},function(data){
						  data=eval("("+data+")");
						  if(data.result=="1"){
	...
	function jxyz(){
	   ...
	   var ruleatype = $('input:radio[name="kqrule.ruleType"]:checked').val();
        ...
        var message="修改考勤策略成功!";
		var message2="修改考勤策略失败!";
