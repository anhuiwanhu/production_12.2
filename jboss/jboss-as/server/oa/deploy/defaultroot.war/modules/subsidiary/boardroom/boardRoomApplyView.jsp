...
<%
    ...
    if(request.getParameter("meetingId") !=null){
      meetingId = EncryptUtil.htmlcode(request.getParameter("meetingId"));
      meetingId = EncryptUtil.replaceHtmlcode(meetingId);
    }
	...
	BoardRoomPO poo = new BoardRoomPO() ;
    if(boardroomId!=null&&!"".equals(boardroomId)&&!"null".equals(boardroomId)){
        poo = new BoardRoomBD().selectBoardroom(new Long(boardroomId));
                       ...
                       <div id="docinfo0" class="doc_Content">
							<!--表单包含页-->
								<table width="100%" border="0" cellpadding="2" cellspacing="1" class="docBoxNoPanel">
                                    ...
                                    <input type="hidden" name="meetingId" value="<%=EncryptUtil.htmlcode(meetingId)%>">
