...
<script> 
 ...
 var zNodes =[
       ...
       // 资产管理  
		...
		,{ id:"menuTitleBox<%=menuIndex%>", pId:0, name:"会务管理", target:'mainFrame',iconSkin:"fa fa"}
		 ,{ id:8000001, expNodeCode:"meetingInfo", pId:"menuTitleBox<%=menuIndex%>", name:"会议通知",  target:'mainFrame',url:"<%=rootPath%>/boardRoom!meetingInformView.action?type=day",iconSkin:"fa fa"}
			...
			/*//新版会议管理
			<%menuIndex++;%>
			 ,{ id:"menuTitleBox<%=menuIndex%>", pId:0, name:"会议管理", target:'mainFrame',iconSkin:"fa fa"}
			 ,{ id:8100000001, pId:"menuTitleBox<%=menuIndex%>", name:"会议通知", expNodeCode:"newmeeting", target:'mainFrame',url:"<%=rootPath%>/newBoardRoom!bdroomMeetingNotice.action",iconSkin:"fa fa"}
			 ,{ id:8100000002, pId:"menuTitleBox<%=menuIndex%>", name:"普通会议室管理",target:'mainFrame',url:"",iconSkin:"fa fa"}
				...
				,{ id:810000000203, pId:8100000002, name:"会议室信息",  target:'mainFrame',url:"<%=rootPath%>/newBoardRoom!newBoardRoomView.action",iconSkin:"fa fa"}
				 <%}%>
			 ,{ id:8100000003, pId:"menuTitleBox<%=menuIndex%>", name:"视频会议室管理",target:'mainFrame',url:"",iconSkin:"fa fa"}
			 ...
			 ,{ id:8100000004, pId:"menuTitleBox<%=menuIndex%>", name:"会议统计",target:'mainFrame',url:"<%=rootPath%>/newBoardRoom!meetingNoticeUseRecordList.action?searchType=type",iconSkin:"fa fa"}
			 ,{ id:8100000005, pId:"menuTitleBox<%=menuIndex%>", name:"设置",iconSkin:"fa fa"}
	...
	}else if('<%=expNodeCode%>'=="newmeeting"){
