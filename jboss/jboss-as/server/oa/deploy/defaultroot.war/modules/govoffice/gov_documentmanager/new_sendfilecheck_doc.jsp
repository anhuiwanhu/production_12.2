...
<head>
	<title><%=Resource.getValue(local,"Gov","gov.newsendfilecheck")%></title>
...
<div class="" id="mainContent" style="overflow-y:auto; position:relative; top:47px; width:100%; _width:99%; "><!--id="mainContent" style="height:100%;width:100%;overflow:auto;"-->
	...
	<input type="hidden" name="content" value="<%=request.getAttribute("field1")==null?"":request.getAttribute("field1").toString()%>">
