...
<head>
    <title><%=Resource.getValue(local,"Gov","gov.bzymxxjg")%></title>
    ...
    %>
    <title><%=Resource.getValue(local,"Gov","gov.zhuanshouwen")%></title>
...
<div class="BodyMargin_10">
    <div class="docBoxNoPanel">
        ...
        <form name="webform" id="webform"  method="post" action="/defaultroot/GovDocReceiveProcess!see.action?fromSendFile=1" target="_parent">
                    ...
                    <td>
                        <div class="whir_radiolist">
                            <label class="whir_label">
                                <select id="dept" class="selectlist" name="docReceiveFileProc" onchange="chReceiveFileProc(this);"  style="width:200px;">
                                    <option value="0">---------<%=Resource.getValue(local,"common","comm.select1")%>------</option>
                                    <%
                                        Object[] rfObj = null;
...
receiveFileRemindField = rfObj[6]==null?"":rfObj[6] + "";*/
                                    ...
                                    <option <%if(receivefilelist.size()==1){%>selected="selected"<%}%> value="<%=receiveFileProcessId%>"><%=receiveFileProcessName%></option>
                                    <%}%>
                                </select>
                            </label>
                ...
                <tr>
                    <td> </td>
                    <td>
                        <input name="" type="button" value="<%=Resource.getValue(local,"common","comm.create")%>" class="btnButton4font" onClick="newDocReceiveFile()" />
                        <input name="" type="button" value="<%=Resource.getValue(local,"common","comm.exit")%>" class="btnButton4font" onClick="closeit()" />
                    </td>
                    <td> </td>
                </tr>
            </table>
