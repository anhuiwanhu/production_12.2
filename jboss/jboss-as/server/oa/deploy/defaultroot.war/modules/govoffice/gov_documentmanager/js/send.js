...
function cmdWordWindowDue(){
    ...
    var tempAccessoryName="";
    if($("*[name='accessoryName']").length > 0){
    var accessoryName=$("#accessoryName").val();
    if(accessoryName!=""){
       var tempArrFileName=accessoryName.split("|");
        for(var i=0;i<tempArrFileName.length;i++){
            tempAccessoryName=tempAccessoryName+tempArrFileName[i]+"\r\n";
        }
    }
    }
    $("*[name='$accessoryName']").val("[发文附件]"+tempAccessoryName);
