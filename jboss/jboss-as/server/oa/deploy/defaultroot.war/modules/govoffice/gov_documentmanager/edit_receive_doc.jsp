...
<head>
	<title><%=Resource.getValue(local,"Gov","gov.receive")%></title>
	            ...
	            <div class="docbox_noline"   >
					<div class="doc_Movetitle">
						<ul>
							...
							<li id="Panle3" ><a href="javascript:void(0);" onClick="changePanle(3);"><%=Resource.getValue(local,"Gov","gov.glflow")%><span class="redBold" id="viewrelationnum"></span></a></li>
							<%if( !"1".equals( request.getAttribute("p_wf_pool_processType") ) ){%>
							...
							<%}%>
							<li id="Panle5" ><a href="#" onClick="changePanle(5);"><%=Resource.getValue(local,"Gov","gov.xgsendfile")%><span class="redBold" id="viewReceivenum"></span></a></li>
							<%if(oa_PDF.equals("1")){%>
							<li id="Panle6" ><a href="#" onClick="changePanle(6);"><%=Resource.getValue(local,"Gov","gov.pdfpz")%></a><span class="redBold" id="viewpdfnum"></span></li>
							<%}%>
						</ul>
					   </div>  
